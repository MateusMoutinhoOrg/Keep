...
var userSchema = lib.NewSchema("users",
...
func newUsers(t *testing.T, d deps.Deps) api.SchemaInstance {
	t.Helper()
	keep := lib.New(d)
	db := keep.NewDatabase(lib.NewProps("testdb/", userSchema))
...
func mustCreate(t *testing.T, users api.SchemaInstance, email, username string, age int) api.SchemaItem {
	t.Helper()
...
func TestMissingRequiredField(t *testing.T) {
	runWithAdapters(t, func(t *testing.T, d deps.Deps) {
		...
		if err == nil || err.Type() != api.MissingField {
...
func TestUpdateIndexedField(t *testing.T) {
	runWithAdapters(t, func(t *testing.T, d deps.Deps) {
		...
		if e := alice.Update("email", "b@x.com"); e == nil || e.Type() != api.KeyConflict {
