...
// string for a Key field, an int64 for an Int field. Asking for a field the
// schema does not declare is a failure, not a nil.
...
func main() {
	...
	// it: the field exists in the schema and holds nothing.
