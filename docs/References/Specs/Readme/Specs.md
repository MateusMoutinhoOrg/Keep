...
- Themes are the pages of `docs/Index/`: `LibUsage.md`, `Development.md`, `Templating.md`.
...
- **Theme ordering follows user need**: consuming the library comes first, because that is how most readers meet the project; then contributing to it; and finally adapting it as a template. A new reader must hit what they need without scrolling past maintainer-only content.
...
5. **Doc Index**: The theme table described above, optionally followed by one line pointing newcomers at the quick start.
