...
- A section link's text is the heading as written; its target is the page path plus the heading's anchor (lowercased, spaces to hyphens, other punctuation dropped) — `/docs/References/PublicApi.md#entry-points`.
