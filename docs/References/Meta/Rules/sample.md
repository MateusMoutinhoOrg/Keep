...
Rules to follow when contributing to this project. Every file must also be shaped by the specification that governs it — locate it in [Specs.md](/docs/References/Meta/Rules/Specs.md).

---

## Specification Compliance

Before creating or editing any file, read [Specs.md](/docs/References/Meta/Rules/Specs.md) and check whether the file matches an **Applies To** entry. If it does, follow the specification that entry points to.
