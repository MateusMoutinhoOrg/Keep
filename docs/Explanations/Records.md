...
## Description
Explains every operation a collection and its records support: creating, finding, reading, updating, deleting, listing, and managing sub-databases. To describe the collections themselves, see [Schemas.md](/docs/Explanations/Schemas.md).
...
Keep assumes a **single writer** unless the backend provides atomic operations. Multiple readers are always safe. See [DenseRecordPattern.md](/docs/Explanations/DenseRecordPattern.md#concurrency-and-atomicity).
