...
func NewItemFactory(sandbox *api.Sandbox, instance *api.SchemaInstance) func(fields map[string]any) (api.SchemaItem, *api.Error) {
	return func(fields map[string]any) (api.SchemaItem, *api.Error) {
		return schemaitem.New(sandbox, instance.Items, instance.Prefix, fields)
	}
}
...
func FindByKeyFactory(sandbox *api.Sandbox, instance *api.SchemaInstance) func(key string, keyValue any) (api.SchemaItem, bool) {
	return func(key string, keyValue any) (api.SchemaItem, bool) {
		...
		return schemaitem.ResolveLive(sandbox, instance.Items, instance.Prefix, raw)
	}
}
...
func FindByIdFactory(sandbox *api.Sandbox, instance *api.SchemaInstance) func(id int64) (api.SchemaItem, bool) {
	return func(id int64) (api.SchemaItem, bool) {
		return schemaitem.ResolveById(sandbox, instance.Items, instance.Prefix, id)
	}
}

// ListAllFactory fills api.SchemaInstance.ListAll, walking the dense list
// from position 1 to the end.
func ListAllFactory(sandbox *api.Sandbox, instance *api.SchemaInstance) func() ([]api.SchemaItem, *api.Error) {
	return func() ([]api.SchemaItem, *api.Error) {
		return schemaitem.ListRange(sandbox, instance.Items, instance.Prefix, 1, 0)
	}
}

// ListFactory fills api.SchemaInstance.List.
func ListFactory(sandbox *api.Sandbox, instance *api.SchemaInstance) func(position int, chunk int) ([]api.SchemaItem, *api.Error) {
	return func(position int, chunk int) ([]api.SchemaItem, *api.Error) {
		return schemaitem.ListRange(sandbox, instance.Items, instance.Prefix, int64(position), int64(chunk))
	}
}
...
func New(sandbox *api.Sandbox, items []api.Item, prefix []string) api.SchemaInstance {
	...
	instance.FindById = FindByIdFactory(sandbox, &instance)
	instance.ListAll = ListAllFactory(sandbox, &instance)
	instance.List = ListFactory(sandbox, &instance)
	return instance
}
